...
// Use the service
const result = await geocodingService.geocodeAddress("123 Main St", "Sacramento", "CA", "95814");
await emailService.sendWelcomeEmail({ firstName: "John", email: "john@example.com", loginUrl: "/login" });
