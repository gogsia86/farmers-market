...
**Purpose**: Hardware optimization, performance profiling, and divine instruction enhancements.
...
**Target Audience**: Developers using HP OMEN hardware  
...
**Status**: Quick reference for GPU profiling
...
- **Performance Scripts**: `profiling_scripts/`
- **Hardware Configuration**: `.vscode/DIVINE_CONFIGURATION_GUIDE.md`
