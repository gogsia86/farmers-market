...
_This executive summary provides a high-level view of the E2E test run results. For detailed failure logs, see `E2E_TEST_RESULTS_SUMMARY.md`. For debugging steps, see the previous thread context._
