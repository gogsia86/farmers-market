...
2. **src/lib/controllers/__tests__/order.controller.test.ts** ✅
   ```typescript
   import { OrderService } from "@/lib/services/order.service";
   ```

3. **src/__tests__/services/order.service.test.ts** ✅
   ```typescript
   import { OrderService, orderService } from "@/lib/services/order.service";
   ```

4. **src/__tests__/services/order.service.consolidated.test.ts** ✅
   ```typescript
   import { OrderService, orderService } from "@/lib/services/order.service";
   ```

5. **src/__tests__/integration/order-workflow.integration.test.ts** ✅
   ```typescript
   import { OrderService, orderService } from "@/lib/services/order.service";
   ```
