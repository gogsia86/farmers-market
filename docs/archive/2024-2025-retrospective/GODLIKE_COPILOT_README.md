...
This repository contains **complete godlike configurations** for GitHub Copilot that transform it from a "helpful assistant" into a **precision engineering tool**. Two optimized setups are provided:

1. **Cursor/VS Code Setup** - Mature ecosystem, extensive features
2. **Zed Setup** - Lightning-fast performance (10x faster)

Both deliver **zero-fluff, production-ready code** with agricultural consciousness embedded.
...
# 5. Test godlike mode
# Ctrl+Shift+I → Type: "Test divine mode"

# 6. Read the guide
# Open: .copilot/GODLIKE_WORKFLOW.md
```
...
# Windows: Download from https://zed.dev/download
...
# 5. Read the guide
# Open: .zed/GODLIKE_WORKFLOW_ZED.md
```
...
├── keybindings.json (370 lines)        # Divine keyboard shortcuts
└── typescript.code-snippets (610 lines) # Code templates

.copilot/
├── directives.md (728 lines)           # ⭐ Core Copilot rules
├── GODLIKE_WORKFLOW.md (786 lines)     # Complete workflow guide
├── TEAM_ONBOARDING.md (462 lines)      # Training guide
└── IMPLEMENTATION_SUMMARY.md (410 lines) # Quick reference
```
...
├── keymap.json (324 lines)             # Zed keyboard shortcuts
├── directives.md (466 lines)           # ⭐ Core Copilot rules (Zed)
├── GODLIKE_WORKFLOW_ZED.md (820 lines) # Complete Zed guide
└── ZED_IMPLEMENTATION_SUMMARY.md (571 lines) # Quick reference
```
...
GODLIKE_COPILOT_README.md (this file)   # Master README
```

**Total**: 6,700+ lines of divine configuration
...
- [ ] First-time code review pass >90%
...
- Accept Farm type from Prisma
- Display farm name, location, image
...
- Zod validation
- QuantumApiResponse format
- Use database from @/lib/database
- Comprehensive error handling
Complete implementation.

# 3. Get complete API route
# 4. Test immediately
```
...
Implement src/lib/services/farm.service.ts with:
- FarmService class
...
4. Don't batch multiple features
```
...
5. Experience the divine difference
...
- [ ] Achieve >90% first-time code review pass rate
- [ ] Teach workflow to others
...
**Impact**: 10x-100x productivity increase

_"From helpful assistant to precision engineering tool - the godlike transformation."_