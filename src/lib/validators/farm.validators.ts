...
export const LocationSchema = z.object({
  ...
  zipCode: z
    ...
    .regex(
      /^\d{5}(-\d{4})?$/,
      "Invalid ZIP code format (e.g., 98101 or 98101-1234)",
    ),
  country: z
    .string()
 ...
 * Validation helpers
 */
export const validateCreateFarm = (data: unknown) =>
  CreateFarmSchema.parse(data);
export const validateUpdateFarm = (data: unknown) =>
  UpdateFarmSchema.parse(data);
