          ...
          <div className="glass-card rounded-2xl p-8 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  By accessing and using Farmers Market platform, you accept and
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  and software, is owned by Farmers Market or its licensors and
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Our maximum liability is limited to the amount paid by you in
                  the past 12 months.
                </p>
              </div>
            </section>
