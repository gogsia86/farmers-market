 ...
 *
 * This route is deprecated and redirects to /api/farmers/finances
 *
 * @deprecated Use /api/farmers/finances instead
 * @see /api/farmers/finances for the consolidated implementation
 *
 * Migration Timeline:
 ...
 *
 * @deprecated
 * Redirects to /api/farmers/finances
 */
...
function redirectToConsolidatedEndpoint(request: NextRequest): NextResponse {
  ...
  const newUrl = new URL("/api/farmers/finances", url.origin);
 ...
 * 🔔 DEPRECATION NOTICE
 *
 * This endpoint has been consolidated into /api/farmers/finances
 *
 * Please update your integrations to use the new endpoint:
 * - Old: /api/farmer/finances
 * - New: /api/farmers/finances
 *
 ...
 * - Enhanced financial reporting features
