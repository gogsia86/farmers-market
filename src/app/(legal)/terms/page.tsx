  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-gray-600 mb-6">Last Updated: January 8, 2025</p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">
            1. Acceptance of Terms
          </h2>
          <p className="text-gray-700 leading-relaxed">
            By accessing and using the Farmers Market Platform ("Platform"), you
          ...
          <p className="text-gray-700 leading-relaxed">
            Permission is granted to temporarily access the materials on Farmers
            Market Platform for personal, non-commercial transitory viewing
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            account and password and for restricting access to their devices.
          ...
          <p className="text-gray-700 leading-relaxed">
            Farmers are responsible for accurate product descriptions, pricing,
            and availability. All products must comply with local food safety
            regulations and applicable laws. The Platform reserves the right to
            remove listings that violate these terms or applicable laws.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            purchase, you agree to provide accurate payment information. Refund
            policies are determined by individual farmers, subject to applicable
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            are owned by Farmers Market Platform and are protected by
          ...
          <p className="text-gray-700 leading-relaxed">
            Farmers Market Platform shall not be liable for any indirect,
          ...
          <p className="text-gray-700 leading-relaxed">
            You agree to indemnify and hold harmless Farmers Market Platform and
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            to the Platform immediately, without prior notice or liability, for
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            the laws of the jurisdiction in which Farmers Market Platform
          ...
          <div className="bg-gray-50 rounded-lg p-4 mt-4">
            <p className="text-gray-700 font-medium">
              Email: support@farmersmarket.app
            </p>
            <p className="text-gray-700 font-medium">
              Address: Farmers Market Platform Legal Department
            </p>
          </div>
        </div>
