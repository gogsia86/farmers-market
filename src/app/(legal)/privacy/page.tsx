      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            account, make a purchase, or communicate with us. This includes:
          </p>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>
              <strong>Between Users:</strong> When you make a purchase, we share
              necessary information (name, delivery address) with the farmer to
              fulfill your order.
            </li>
            <li>
            ...
            <li>
              ...
              merger, sale of company assets, or acquisition, your information
              may be transferred.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>
              ...
              account information at any time through your account settings.
            </li>
            <li>
              <strong>Delete:</strong> You can request deletion of your account
              and personal information by contacting us.
            </li>
            <li>
              <strong>Opt-Out:</strong> You may opt out of receiving promotional
              emails by following the unsubscribe link in those emails.
            </li>
            <li>
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            a small amount of data that are sent to your browser and stored on
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            take appropriate safeguards to ensure your data is treated securely
          ...
          <div className="bg-gray-50 rounded-lg p-4 mt-4">
            <p className="text-gray-700 font-medium">
              Email: privacy@farmersmarket.app
            </p>
            <p className="text-gray-700 font-medium">
              Data Protection Officer: dpo@farmersmarket.app
            </p>
            <p className="text-gray-700 font-medium">
              Address: Farmers Market Platform Privacy Team
            </p>
          </div>
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            what personal information we collect, the right to delete your
