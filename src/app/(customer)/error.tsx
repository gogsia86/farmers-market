...
/**
 * 🛒 CUSTOMER ROUTES ERROR BOUNDARY
 *
 * Catches errors in customer-facing routes
 * Provides shopping-specific error recovery
 */

import { Button } from "@/components/ui/button";
import { logger } from "@/lib/monitoring/logger";
import { AlertTriangle, Home, RefreshCcw, ShoppingCart } from "lucide-react";
      ...
      <div className="max-w-xl w-full bg-card border border-border rounded-xl shadow-lg p-8">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-foreground mb-3">
            🛒 Shopping Experience Interrupted
          </h2>
          <p className="text-muted-foreground mb-2">
            We encountered an issue while loading your shopping experience.
          </p>
          <p className="text-sm text-muted-foreground">
            Don't worry, your cart and favorites are safe!
          </p>
        </div>
