...
export const metadata: Metadata = {
  ...
  description: "Get in touch with us for questions, support, or partnership opportunities",
};
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <a href="mailto:support@farmersmarket.com" className="text-sm font-medium text-green-700 hover:underline">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <h3 className="mb-2 text-lg font-semibold text-gray-900">Farmer Support</h3>
              <p className="mb-3 text-sm text-gray-600">
                Questions about selling on our platform?
              </p>
              <a href="mailto:farmers@farmersmarket.com" className="text-sm font-medium text-green-700 hover:underline">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <a href="tel:+18005551234" className="text-sm font-medium text-green-700 hover:underline">
                1-800-555-1234
              </a>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <div className="flex gap-4">
                <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-700 transition-colors hover:bg-green-100 hover:text-green-700">
