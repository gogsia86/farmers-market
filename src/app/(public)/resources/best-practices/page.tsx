          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8">
                ...
                these practices to grow your business and delight your
                customers.
              </p>
            </div>
          </div>
              ...
              <div className="glass-card rounded-2xl p-8 md:p-12">
                ...
                <div className="mt-8 p-6 bg-primary-50 dark:bg-primary-900/10 rounded-xl border-2 border-primary-200 dark:border-primary-900/30">
                  <p className="text-sm text-foreground">
                    <strong>💡 Pro Tip:</strong> Don't try to implement
                    everything at once. Focus on 2-3 practices per month and
